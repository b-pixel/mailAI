...
| Жиры | **1,0 г/кг × 93 кг = 93 г/день** | выбор пользователя; не превышать; в резюме дня: **съедено − 93 г** (минус = запас, плюс = перебор) |
| Углеводы | **только учёт** | лимита нет; фиксируем факт в граммах |

В каждом дне считаем: приход ккал + белок + жиры (± к 93 г) + углеводы (факт) + остаток по ккал и белку.
